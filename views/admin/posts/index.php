                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <p class="text-sm text-gray-600">
                            Showing <span class="font-semibold text-gray-900"><?= count($posts) ?></span> of
                            <span class="font-semibold text-gray-900"><?= $totalPosts ?? 0 ?></span> posts
                        </p>
                        ...
                        <?php if (isset($totalPages) && $totalPages > 1): ?>
                            <div class="flex items-center space-x-2">
                                ...
                                <?php if ($currentPage > 1): ?>
                                    <a href="/admin/posts?page=<?= $currentPage - 1 ?>"
                                ...
                                <div class="hidden sm:flex items-center space-x-1">
                                    ...
                                    if ($startPage > 1): ?>
                                        <a href="/admin/posts?page=1" class="px-3 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-sm">1</a>
                                        <?php if ($startPage > 2): ?>
                                    ...
                                    <?php if ($endPage < $totalPages): ?>
                                        <?php if ($endPage < $totalPages - 1): ?>
                                            <span class="px-2 text-gray-500">...</span>
                                        <?php endif; ?>
                                        <a href="/admin/posts?page=<?= $totalPages ?>" class="px-3 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-sm"><?= $totalPages ?></a>
                                    <?php endif; ?>
                                </div>
