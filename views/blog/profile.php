            ...
            <div class="mt-12 flex justify-center">
                <nav class="flex items-center space-x-2">
                    ...
                    <?php if ($currentPage > 1): ?>
                        <a href="/profile?username=<?= urlencode($author['username']) ?>&page=<?= $currentPage - 1 ?>"
                    ...
                    <div class="hidden sm:flex items-center space-x-1">
                        ...
                        if ($startPage > 1): ?>
                            <a href="/profile?username=<?= urlencode($author['username']) ?>&page=1" class="px-3 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-sm">1</a>
                            <?php if ($startPage > 2): ?>
                        ...
                        <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                            <a href="/profile?username=<?= urlencode($author['username']) ?>&page=<?= $i ?>"
                        ...
                        <?php if ($endPage < $totalPages): ?>
                            <?php if ($endPage < $totalPages - 1): ?>
                                <span class="px-2 text-gray-500">...</span>
                            <?php endif; ?>
                            <a href="/profile?username=<?= urlencode($author['username']) ?>&page=<?= $totalPages ?>" class="px-3 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-sm"><?= $totalPages ?></a>
                        <?php endif; ?>
                    </div>
