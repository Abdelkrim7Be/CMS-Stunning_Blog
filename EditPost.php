...
// echo $current;
  ...
  // }  
    ...
    // Query to Update the data when everything is fine
    global $connectingDB;
    ...
    // var_dump($Execute);
    if ($Execute) {
      $_SESSION["SuccessMessage"] = "Successful operation, Post with id : " . $SearchQueryParameter . " is updated  successfully";
  ...
  <section class="container py-2 mb-4">
    <div class="row">
      ...
      <div class="offset-lg-1 col-lg-10" style="min-height: 400px;">
        ...
        ?>
        <form action="EditPost.php?id=<?php echo $SearchQueryParameter; ?>" method="post" class=""
          ...
          <div class="card-body bg-dark">
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="PostTitle" id="title"
                value="<?php echo $TitletoBeUpdated; ?>" placeholder="type title here">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="Post" name="PostDescription" cols="30"
                rows="10"><?php echo $PostToBeUpdated; ?></textarea>
            </div>
            <div class="row">
              <!-- style="min-height: 50px; background-color: yellow;" -->
